...
/*
// TreeNode * build(vector<int> &a, vector<int> &b,int &post,int start,int end)
//  {
//     if(start>end)
//     return NULL;
//     int curr = b[post--];
...
//          }
//      }
//     root->right = build(a,b,post,i+1,end);
//     root->left = build(a,b,post,start,i-1);
//     return root;
//  }
// TreeNode* Solution::buildTree(vector<int> &a, vector<int> &b) {
//     // unordered_map<int,int> m;
